        ...
        <div>
            ...
            <div>
                <WelcomeContainer 
                    ...
                    customButton='bg-green-700 text-sm md:text-lg font-semibold'
            ...
            <div>
                <Heads title='Protégez votre nom commercial facilement' structure='font-bold text-center py-8' headcust='text-2xl' />
            </div>

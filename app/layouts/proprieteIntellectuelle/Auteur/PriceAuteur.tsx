...
const Price = () => {
  return (
    <div className='py-6 bg-gray-50'>
      <div className='w-full max-w-md px-4 sm:px-6 md:px-8 lg:px-12 mx-auto'>
        <div className='relative text-center border-4 border-green-700 rounded-md p-4 md:p-6'>
          ...
          <Button title='Commencer' structure='capitalize px-4 py-2 md:px-6 md:py-3 absolute bottom-0 left-1/2 transform -translate-x-1/2 bg-green-700 w-64 md:w-72 rounded-sm text-white font-bold text-base md:text-xl' />
        </div>
      </div>
    </div>
  );

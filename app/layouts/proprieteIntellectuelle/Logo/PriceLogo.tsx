    ...
    <div className='py-6 bg-gray-50'>
      <div className='w-full md:w-8/12 mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-8'>
          <div className='relative text-center border-4 border-green-700 rounded-md h-[630px] md:h-[650px] px-6 md:px-12 py-6'>
            ...
            <Button title='commencer' structure='capitalize px-6 py-3 bg-green-700 rounded-sm my-4 absolute bottom-0 mb-4 left-1/2 transform -translate-x-1/2 text-white font-bold md:text-xl text-sm' />
          </div>

...
const HomePropriete = () => {
    ...
    const faqData = [
        {
          question: "Qu'est-ce que la Propriété Intellectuelle, et à quoi sert-elle ?",
        ...
        {
          question: "Quels sont les avantages de la Propriété Intellectuelle pour les startupeurs ?",
          answer: "La LegalTech permet aux particuliers de : \n* Bénéficier de conseils juridiques en ligne à moindre coût. \n* Gérer eux-mêmes certaines démarches juridiques simples (rédaction de contrats, rédaction de testaments, etc.). \n* Avoir accès à des informations juridiques claires et précises.",
        },
        {
          question: "Quels sont les différents aspects de la Propriété Intellectuelle ?",

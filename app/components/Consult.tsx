  ...
  return (
    <div className='border py-6 m-auto rounded-md'>
        <div className='text-center w-full'>
            <h2 className='font-semibold md:text-xl px-20 py-2 text-semibold uppercase'>Consulter un expert juridique n&apos;a jamais été aussi facile</h2>
        ...
        <div className='w-full px-4'>
            <form action="submit" className='py-4 m-auto'>
                <input type="email" className='border w-full my-2 focus:border-green-500 px-2 py-3 rounded-md focus:outline-none' placeholder='contact@tribunejustice.com' /><br />

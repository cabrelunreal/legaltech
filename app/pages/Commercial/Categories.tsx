...
const Categories: React.FC = () => {
  ...
  const Description = "Découvrez d'autres services auxquels vous pouvez souscrire.";
  ...
  const categories = [
    ...
    { title: 'Propriété Littéraire et Artistique', image: 'https://res.cloudinary.com/dedakscgk/image/upload/v1721945471/droits-dauteur_fyk0w9.png', description: 'artistiques', link: '../../../pages/Auteur' },
  ];

...
const Price = () => {
  return (
    <div className='py-6 bg-gray-50'>
      <div className='w-full lg:w-7/12 px-4 lg:px-42 grid grid-cols-1 lg:grid-cols-2 gap-8 m-auto'>
        <div className='relative text-center border-4 h-auto lg:h-[650px] px-6 border-green-700 rounded-md'>
          ...
          <Heads title='699 $ | 699FCFA' headcust='text-xl text-green-700 font-bold' cust='hidden' structure='' />
        ...
        <div className='relative text-center border-4 h-auto lg:h-[650px] px-6 border-green-700 rounded-md'>
          ...
          <Button title='Après avoir terminé la première étape' structure='capitalize px-6 py-1 absolute bottom-0 mb-4 left-1/2 transform -translate-x-1/2 bg-green-700 w-64 rounded-sm text-white font-bold text-xl' />
        </div>
      </div>

      <div className='relative w-full lg:w-3/12 mt-14 mb-6 m-auto text-center border-4 h-auto lg:h-[340px] px-6 border-green-700 rounded-md'>
        ...
        <Button title='commencer' structure='capitalize px-6 py-3 absolute bottom-0 mb-4 left-1/2 transform -translate-x-1/2 bg-green-700 w-64 rounded-sm text-white font-bold text-xl' />
      </div>
    </div>
  );
};

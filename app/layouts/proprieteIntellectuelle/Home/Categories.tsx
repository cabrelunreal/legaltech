...
const Categories: React.FC = () => {
  ...
  const categories = [
    ...
    { title: 'Dessins et Modèle Industriel', image: 'https://res.cloudinary.com/dedakscgk/image/upload/v1721945471/conception_kblfif.png', description: 'industriel', link: '../../../pages/DessinEtModele' },
    ...
    { title: 'Proprieté Litteraires et Artistiques', image: 'https://res.cloudinary.com/dedakscgk/image/upload/v1721945471/droits-dauteur_fyk0w9.png', description: 'artistiques', link: '../../../pages/Auteur' },
